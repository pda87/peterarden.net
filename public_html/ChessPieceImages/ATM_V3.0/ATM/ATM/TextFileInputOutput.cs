  ...
  class TextFileInputOutput
  {
    internal static void CreateStorage()
    {
       if (!Directory.Exists("C:\\ATM"))
       {
           ...
           File.WriteAllText("C:\\ATM\\AccountDatabase.txt", "ACCOUNT NUMBER: 100000 PIN: 1234 BALANCE: 10000 CURRENCY: true\r\nACCOUNT NUMBER: 100001 PIN: 1234 BALANCE: 20000 CURRENCY: false\r\n");
       }
    }
